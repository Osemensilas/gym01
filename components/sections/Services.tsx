        ...
        <section className="h-max w-full flex flex-col gap-5 px-4 sm:px-10 py-10 bg-foreground">
            ...
            <div className="h-max w-full flex flex-col sm:flex-row justify-between items-center">
                ...
                <div className="h-max w-full sm:w-2/5 hidden sm:flex justify-end items-center gap-5">
                    <button title="nav btn" onClick={scrollLeft} type="button" className="h-7 w-15 text-accent text-sm cursor-pointer flex items-center justify-center rounded-full bg-primary">
                        <i className="fa-solid fa-chevron-left"></i>
                    </button>
                    <button title="nav btn" onClick={scrollRight} type="button" className="h-7 w-15 text-accent text-sm cursor-pointer flex items-center justify-center rounded-full bg-primary">
                        <i className="fa-solid fa-chevron-right"></i>
                    </button>
                </div>
            </div>
            <div ref={scrollRef} className="h-max w-full overflow-x-auto sm:overflow-hidden scroll-smooth">
