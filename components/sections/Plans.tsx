const Plans = () => {
    return ( 
        ...
        <section className="h-max w-full flex flex-col gap-5 px-10 py-10 bg-foreground">
            ...
            <div className="h-max w-full flex items-center justify-between gap-5 pt-5">
                <div className="h-max w-[30%] bg-background rounded-xl p-5">
                ...
                <div className="choosen h-max w-[30%] bg-background rounded-xl p-5">
                    <h3 className="relative z-10 text-xl text-center text-accent mb-5 font-bold">Daily Plan</h3>
