const ContactForm = () => {
  return (
    <>
        <form className="space-y-4 bg-backgroundLight px-0 sm:px-5 py-5 rounded w-full h-full">
            <div className="h-max w-full flex flex-col sm:flex-row gap-4">
                <input type="text" placeholder="Full Name" className="w-full h-10 px-3 border border-accent/50 outline-none rounded text-sm text-accent/50" />
                <input type="email" placeholder="Your Email" className="w-full h-10 px-3 border border-accent/50 outline-none rounded text-sm text-accent/50" />
            </div>
            <div className="h-max w-full flex flex-col sm:flex-row gap-4">
